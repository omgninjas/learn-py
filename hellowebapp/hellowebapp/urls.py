...
urlpatterns = [
    ...
    url(r'^contact/$',
        ...
        name='contact'),
    url(r'^quotes/$', RedirectView.as_view(pattern_name='browse', permanent=True)),
    ...
    url(r'^accounts/password/reset/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>[0-9A-ZAa-z]{1,13}-[0-9A-Za-z]{1,20})/$',
        password_reset_confirm,
    ...
    url(r'^accounts/create_quote/$', views.create_quote, name='registration_create-quote'),
